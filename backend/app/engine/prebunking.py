...
DETECTION_PATTERNS = {
    ...
    "false_authority": [
        ...
        r'(?i)(?:哈佛|牛津|剑桥|斯坦福)\S{0,8}(?:研究|教授|学者|团队)',
    ...
    "fear_mongering": [
        r'(?i)(?:正在.{1,10}(?:摧毁|破坏|吞噬|威胁))',
        r'(?i)(?:再不看.{1,10}就晚了)',
        r'(?i)(?:你的.{1,10}正在.{1,10}(?:悄悄|偷偷|暗中))',
        r'(?i)(?:下一个.{1,8}(?:就是你|可能就是你|就是你的))',
    ],
    "context_stripping": [
        r'(?i)(?:100%|绝对|肯定|必然|毫无疑问)\s*(?:安全|危险|致癌|有效|无效|有毒)',
        r'(?i)(?:含有|检测到)\s*(?:有毒|致癌|放射性)\s*(?!(?:剂量|浓度|含量|ppm|mg))',
        r'(?i)(?:比砒霜还毒|比氰化物还强)',
        r'(?i)(?:禁止|禁用|召回)\s*[^。]{0,20}(?!(?:原因|条件|前提|范围))',
    ],
